...
<body><br><br><br><br><br><br><br><br><br><center>
  ...
  <div class="header"> 
    <div class="image">
      ...
      <div class="content">
         ...
         <div class="actions">
            <button type="button" class="history"><a href="vechicle.php" style="text-decoration:none;color:white">Continue</a></button> 
            <button type="button" class="track"><a href="index.php"style="text-decoration:none;color:black">Back to home</button> 
            </div> 
            </div> 
            </div>
</body>
